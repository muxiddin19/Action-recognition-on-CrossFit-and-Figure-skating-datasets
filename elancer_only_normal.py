...
ann_file_train = 'data/dataset/crossfit_train_norm1.pkl'
ann_file_test = 'data/dataset/crossfit_test_norm1.pkl'
ann_file_val = 'data/dataset/crossfit_val_norm1.pkl'
...
log_level = 'INFO'
work_dir = './work_dirs/elancer_only_normal'
load_from = None
resume_from = None
